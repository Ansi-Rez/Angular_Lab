...
export class ReviewdetailComponent implements OnInit{
  reviewTitle = '';
  filterargs = {title: this.reviewTitle};
  constructor(private route: ActivatedRoute) {
      this.reviewTitle = String(this.route.snapshot.params['review_title']);
  ...
  ngOnInit(): void {
    ...
    this.newlist = this.allreviews.filter(allreviews => allreviews?.review_title.toLowerCase().includes(this.reviewTitle.toLowerCase()));
  }
